...
//void layer_d5(feature_t* input, feature_t* biases, feature_t* output);
//void layer_d6(feature_t* input, feature_t* biases, feature_t* output);
//void layer_d7(feature_t* input, feature_t* biases, feature_t* output);
