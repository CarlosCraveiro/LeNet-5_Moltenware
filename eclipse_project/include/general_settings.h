...
/* Flattening Layer */
#define FLAT_INPUT_SIZE ( P4_OUTPUT_SIZE )
#define FLAT_INPUT_CHANNELS ( P4_INPUT_CHANNELS )
#define FLAT_OUTPUT_SIZE ( P4_OUTPUT_SIZE * P4_OUTPUT_SIZE * P4_OUTPUT_CHANNELS )
#define FLAT_OUTPUT_CHANNELS 1

/* D5 Layer */
#define D5_INPUT_SIZE ( FLAT_OUTPUT_SIZE )
#define D5_INPUT_CHANNELS ( FLAT_OUTPUT_CHANNELS )
